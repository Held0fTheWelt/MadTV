var Rooms = IgeEntity.extend({
    ...
    init: function () {
        ...
        // Bureau door 1 opened
        gameTexture[6] = new IgeTexture('assets/textures/accessoires/bureau/buro12.png');
        // Bureau door 2 opened
        gameTexture[7] = new IgeTexture('assets/textures/accessoires/bureau/buro22.png');
        // Bureau door 3 opened
        gameTexture[8] = new IgeTexture('assets/textures/accessoires/bureau/buro32.jpg');
        // The open lobby
        gameTexture[9] = new IgeTexture('assets/textures/accessoires/lobby/lobbyOpened.jpg');
        ...
        ige.on('texturesLoaded', function () {
            ...
            nodeSSRooms.obj[0] = new GameElement()
                ...
                .mouseUp(function () {
                    ...
                    ige.client.obj[7].changePosition(-285,0);
                })
            ...
            nodeSSRooms.obj[1] = new GameElement()
                ...
                .mouseUp(function () {
                    ige.client.obj[7].changePosition(300,0);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[2] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(-325,1);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[4] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(-225,2);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[6] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(325,2);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[7] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[7])
                        .height(90);
                    ige.client.obj[7].changePosition(-325,3);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[8] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[7])
                        .height(90);
                    ige.client.obj[7].changePosition(-225,3);
                })
            ...
            nodeSSRooms.obj[10] = new GameElement()
                ...
                .mouseUp(function () {
                    ...
                    ige.client.obj[7].changePosition(-325,4);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[11] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-225,4);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[14] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[7])
                        .height(90);
                    ige.client.obj[7].changePosition(-225,5);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[16] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(-325,6);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[18] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-325,7);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[19] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-225,7);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[22] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(225,8);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[14] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[7])
                        .height(90);
                    ige.client.obj[7].changePosition(-325,9);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[15] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[7])
                        .height(90);
                    ige.client.obj[7].changePosition(225,9);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[18] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-325,10);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[19] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-225,10);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[22] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[6])
                        .height(90);
                    ige.client.obj[7].changePosition(-225,11);
                })
                .mount(nodeSSRooms);
            ...
            nodeSSRooms.obj[18] = new GameElement()
                ...
                .mouseUp(function () {
                    this.texture(gameTexture[8]);
                    ige.client.obj[7].changePosition(-325,12);
                })
                .mount(nodeSSRooms);
